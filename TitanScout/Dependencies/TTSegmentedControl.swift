...
open class TTSegmentedControl: UIView {
	...
	@IBInspectable open var selectedTextColor: UIColor = Switch().tintColor
	@IBInspectable open var useGradient: Bool = true
	
	@IBInspectable open var containerBackgroundColor: UIColor = UIColor.clear
	@IBInspectable open var thumbColor: UIColor = UIColor.clear
	@IBInspectable open var thumbGradientColors: [UIColor]? = [Switch().tintColor,Switch().tintColor]
	@IBInspectable open var thumbShadowColor: UIColor = Switch().tintColor
...
//		thumbView.backgroundColor = thumbColor
		...
		if useShadow {
			shadowLayer.shadowColor = thumbColor.cgColor
			shadowLayer.borderWidth = 1.0
			shadowLayer.borderColor = thumbColor.cgColor
			shadowLayer.shadowOffset = CGSize(width: 0.1, height: 0.1);
